...
/*
====================================================================================
Tipo de Consulta: Trabalho Fases Manutenção - Consulta 1 (TRAB.EM DETERMINADA FASE)
====================================================================================
*/

IF OBJECT_ID ( 'dbo.PRC_GRF_Consulta_Trabalhos_1') IS NOT NULL DROP PROCEDURE dbo.PRC_GRF_Consulta_Trabalhos_1
GO  

CREATE PROCEDURE dbo.PRC_GRF_Consulta_Trabalhos_1 (
							                       @pk_fase int
							                      )
